...
if __name__=="__main__":
    ...
    parser.add_argument("-c", "--container", type=str, default="pdc-ros-container", help="(optional) name of the container")\
    ...
    pdc_source_dir = os.path.join(source_dir, "pytorch-dense-correspondence")
    config_file = os.path.join(os.getcwd(), 'docker_run_config.yaml')
